...
class DatasetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dataset" do
    assert_difference("Dataset.count") do
      post datasets_url, params: { dataset: { description: @dataset.description, key: @dataset.key, title: @dataset.title } }
    end
  ...
  test "should update dataset" do
    patch dataset_url(@dataset), params: { dataset: { description: @dataset.description, key: @dataset.key, title: @dataset.title } }
